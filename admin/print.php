...
<body>
	...
	// Use the Payment class to fetch data from the database.
	$payment = new Payment();
	$payment->find_id($pid);
	...
	$troom = $payment->getTotalRooms();
	$bed = $payment->getTotalBeds();
	$nroom = $payment->getNumRooms();
	$cin = $payment->getCheckInDate();
	$cout = $payment->getCheckOutDate();
	$meal = $payment->getMeal();
	$ttot = $payment->getTotalAmount();
	$mepr = $payment->getMealPrice();
	$btot = $payment->getBaseTotal();
	$fintot = $payment->getFinalTotal();
	$days = $payment->getNumberOfDays();
